...
function Hero() {
    return(
        <div className="grid-bg w-full flex flex-col items-center justify-center gap-4 text-center py-24 px-4">
    ...
    return(
        <div id="features" className="w-full flex flex-col items-center justify-center gap-4 text-center py-8 px-4 
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 w-full max-w-6xl my-8">
                {features.map((f, i) => (
                    <div key={i} className="flex items-start flex-col p-4 gap-4 bg-secondary border rounded-lg
    ...
    return(
        <div id="problem" className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 items-start justify-start gap-8 py-24 px-4">
            ...
            <div className="col-span-1 lg:col-span-3 flex flex-col gap-4">
                {stages.map((s, i) => (
                    <div key={i} className="flex flex-col gap-2 py-4 pr-4 pl-12 hover:bg-secondary rounded-lg relative">
